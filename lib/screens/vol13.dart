...
class VoleybolU13U14Page extends StatelessWidget {
  const VoleybolU13U14Page({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(
          'U13-U14 Voleybol Antrenman Programı',
          style: GoogleFonts.poppins(fontSize: 24, fontWeight: FontWeight.bold),
        ),
        backgroundColor: const Color.fromARGB(255, 0, 12, 248), // Mavi renk
      ),
      body: Padding(
        ...
        child: ListView(
          children: [
            // 1. Çeyrek
            Card(
              color: const Color.fromARGB(255, 0, 34, 255), // Mavi renk
            ...
            // 2. Çeyrek
            Card(
              color: const Color.fromARGB(255, 0, 17, 255), // Mavi renk
              shape: RoundedRectangleBorder(
                borderRadius: BorderRadius.circular(10),
              ),
              child: Padding(
            ...
            // 3. Çeyrek
            Card(
              color: const Color.fromARGB(255, 0, 42, 255), // Mavi renk
              shape: RoundedRectangleBorder(
                borderRadius: BorderRadius.circular(10),
              ),
              child: Padding(
