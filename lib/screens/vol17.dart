...
class VoleybolU17_19Page extends StatelessWidget {
  const VoleybolU17_19Page({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(
          'U17-U19 Voleybol Antrenman Programı',
          style: GoogleFonts.poppins(fontSize: 24, fontWeight: FontWeight.bold),
        ),
        backgroundColor: const Color.fromARGB(255, 0, 8, 255), // Lacivert renk
      ),
      body: Padding(
        ...
        child: ListView(
          children: [
            // 1. Çeyrek
            Card(
              color: const Color(0xFF6439FF), // Yeni renk
